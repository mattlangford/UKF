...
class Gyroscope final: public SensorBase
{

//
// The gyroscope uses it's measurements to update the WX, WY, and WZ states
// along with the biases associated with each of those.
// Eventually it will also play a roll in RX, and RY as well - soon.
//
// Below is an enum for milling around in the observation vector
...
public: // methods ///////////////////////////////////////////////////////////
                                       ...
                                       const State &predicted_state) const
    {
        ...
        {
            const State &state = points[i];
            expected_observations.col(i) = state.angular_vel;
        }
